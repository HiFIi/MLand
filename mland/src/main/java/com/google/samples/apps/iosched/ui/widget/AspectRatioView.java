...
/**
 * Extension of FrameLayout that assumes a measured (non-zero) width and sets the height according
 * to the provided aspect ratio.
 */
public class AspectRatioView extends FrameLayout {
  ...
  public AspectRatioView(Context context, AttributeSet attrs, int defStyle) {
    ...
    final TypedArray a =
        context.obtainStyledAttributes(attrs, R.styleable.AspectRatioView, defStyle, 0);
